...
void drawConfig(){
  background(255);
  textSize(30);
  text("Hund",width/2-35,height/5-40);
  drawFigure(width/4,height/5);
  text(hund,width/2-6,height/5+15);
  
  text("Number of turns",width/3+80,2*height/5-40);
  drawFigure(width/4,2*height/5);
  text(turn,width/2-6,2*height/5+15);
  
  text("Lower limit of random number",width/3-10,3*height/5-40);
  drawFigure(width/4,3*height/5);
  text(rLow,width/2-6,3*height/5+15);
  
  text("Upper limit of random number",width/3-10,4*height/5-40);
  drawFigure(width/4,4*height/5);
  text(rHigh,width/2-6,4*height/5+15);
...
void drawResult(int win,int lose,String result){
  ...
  textSize(30);
  text("Press Enter to back to the title",width/4+100,3*height/4);
}
